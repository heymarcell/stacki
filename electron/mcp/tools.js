...
const INSTRUCTIONS = [
  ...
  'they appear on the canvas, land on the undo stack the user can press \u2318Z on, and save normally. Pass the',
  'expectedRevision and expectedDigest from your read into your write and a change somebody made in between is',
  'refused rather than overwritten. Bound text is never silently replaced with a literal — the answer says where',
  'the value lives. A node inside a loop is one node rendered many times, and the answer says that too. Use your',
  'normal repository tools for code outside Stacki\'s model; it is a fast path, not a fence. get_capabilities says',
  'what this permission level may do. Capture after a visual change, verify it before you resolve a review, and',
  'defer one you are deliberately not implementing, with a reason. Stacki already owns the preview server; do not',
